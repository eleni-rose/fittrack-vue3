  ...
  <section class="section is-large">
    <div class="columns">
      <div class="column is-half is-offset-one-quarter">
        ...
        <div v-else class="card" v-for="post in activityFeed" :key="post.username">
          <div class="card-content">
            <div class="media">
              <div class="media-left">
                <figure class="image is-48x48">
                  <img class="is-rounded" :src="`data:image/png;base64,${post.profilePic}`" alt="Placeholder image" />
                </figure>
              </div>
