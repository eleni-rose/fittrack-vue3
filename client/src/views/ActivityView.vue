  ...
  <div class="columns">
    <div class="column is-half is-offset-one-quarter">
      ...
      <section class="section is-small">
        <div class="card" v-for="activity in activities" :key="activity.username">
            ...
            <div class="media">
              <div class="media-left">
                <figure class="image is-48x48">
                  <img
                    class="is-rounded"
                    :src="`data:image/png;base64,${ activity.profilepic }`"
                    alt="Placeholder image"
                  />
                </figure>
              </div>
              <div class="media-content">
                <p class="title is-4">{{ activity.displayname }}</p>
